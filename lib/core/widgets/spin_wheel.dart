          ...
          Container(
            ...
            decoration: BoxDecoration(
              gradient: const LinearGradient(
                ...
                colors: [
                  AppColors.lightTextPrimary, // Dark green
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final gradient = LinearGradient(
      ...
      colors: [
        ...
        AppColors.lightTextPrimary, // Dark green at bottom
      ],
    );
    ...
    canvas.drawCircle(Offset(size.width / 2, 0), 8, whitePaint);
  }
...
class WheelPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int i = 0; i < prizes.length; i++) {
      ...
      final color = i % 2 == 0 ? AppColors.primary : AppColors.lightTextPrimary;
